...
SupplierRouter.post(
  ...
  SupplierController.supplierRegistration
);
...
SupplierRouter.get(
  "/supplier/details/getAll",
  SupplierController.getAll_supplier_details
);
...
SupplierRouter.get(
  ...
  SupplierController.getSupplierDetailsByName
);

// Update Supplier Details
SupplierRouter.put(
  "/update/supplier/details/:id",
  SupplierController.update_supplier_details
);
